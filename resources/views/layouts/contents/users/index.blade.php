    ...
    <div class="row">
        ...
        <div class="col-xl-8 col-lg-7 col-md-7 order-1 order-md-1">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form id="register-user-form" class="needs-validation" method="POST" action="{{route('update_profile')}}" novalidate>
                        @csrf
                        <div class="row">
                            ...
                            <div class="mb-1 col-md-6">
                                ...
                                <input type="text" id="username" name="username" value="{{$my_data->username ?? ''}}" class="form-control"
                                       placeholder="Username" aria-label="Username" aria-describedby="username" required readonly/>
                        ...
                        <div class="row">
                            ...
                            <div class="mb-1 col-md-6">
                                ...
                                <input type="text" id="national_id" name="national_id" value="{{$my_data->national_id ?? ''}}" class="form-control"
                                       placeholder="National ID" aria-label="National ID" aria-describedby="national_id" required readonly/>
                                {{--                                <div class="valid-feedback">Looks good!</div>--}}
                                <div class="invalid-feedback">Please enter your national id.</div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="mb-1 col-md-6">
                                ...
                                <input type="text" id="address" name="address" value="{{$my_data->address ?? ''}}" class="form-control" placeholder="address" aria-label="address" required />
                                {{--                                <div class="valid-feedback">Looks good!</div>--}}
